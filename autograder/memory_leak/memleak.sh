...
case "$file" in
*.c)
    gcc -c leak_detector_c.c --include leak_detector_c.h
    gcc -c $file --include leak_detector_c.h
    gcc -o memtest leak_detector_c.o ${file%.*}.o --include leak_detector_c.h
    ;;
*.cpp | *.c++ | *.cc | *.cxx | *.CPP | *.cp | *.C)
    gcc -c leak_detector_c.c --include leak_detector_c.h
    g++ -c $file --include leak_detector_c.h
    g++ -o memtest leak_detector_c.o ${file%.*}.o --include leak_detector_c.h
    ;;
*)
